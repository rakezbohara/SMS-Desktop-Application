...
public class EditStaff extends javax.swing.JFrame {
    ...
    public EditStaff(String selID,String[] info){
        initComponents();
        setLocationRelativeTo(null);
       dbh = new DBHelper();
        //System.out.println(info[0]);
         ...
         jtype.setSelectedItem(info[10]);
         contact.setText(info[11]);
         post.setText(info[12]);
         gender.setSelectedItem(info[13]);
         bloodgroup.setSelectedItem(info[14]);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Edit Staff Info");
        ...
        jtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "FULL TIME", "PART TIME" }));
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(jPanel4Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(qauli, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel4Layout.createSequentialGroup()
                                                .addGap(76, 76, 76)
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(ipath.getText().equals("")){
        dbh.updatestaffdata(selectedID,csubject,cfname,cmname,clname,cgender,cdob,ccontact,ctaddress,cpaddress,ccaste,cenroll,cbloodgroup,cpost,cquali,ctype);  
        }else{
        dbh.updatestaffdata(selectedID,csubject,cfname,cmname,clname,cgender,cdob,ccontact,ctaddress,cpaddress,ccaste,cenroll,personImage,cbloodgroup,cpost,cquali,ctype);
        }
        //System.out.println("hello cjd");
        //set to deafault
